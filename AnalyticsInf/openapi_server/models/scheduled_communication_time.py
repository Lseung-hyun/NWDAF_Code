...
class ScheduledCommunicationTime(Model):
    ...
    def time_of_day_start(self):
        ...
        String with format partial-time or full-time as defined in subclause 5.6 of IETF RFC 3339. Examples, 20:15:00, 20:15:00-08:00 (for 8 hours behind UTC).  # noqa: E501
