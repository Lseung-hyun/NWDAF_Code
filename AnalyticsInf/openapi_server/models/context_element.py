...
class ContextElement(Model):
    ...
    def __init__(self, context_id=None, pend_analytics=None, hist_analytics=None, last_output_time=None, aggr_subs=None, hist_data=None, adrf_id=None, adrf_data_types=None, aggr_nwdaf_ids=None, model_prov_ids=None):  # noqa: E501
        ...
        :param model_prov_ids: The model_prov_ids of this ContextElement.  # noqa: E501
        :type model_prov_ids: List[str]
        """
        self.openapi_types = {
        ...
        self._model_prov_ids = model_prov_ids
    ...
    @property
    def model_prov_ids(self):
        """Gets the model_prov_ids of this ContextElement.

        Identifiers of NWDAFs that provide ML models used by the NF service consumer.  # noqa: E501

        :return: The model_prov_ids of this ContextElement.
        :rtype: List[str]
        """
        return self._model_prov_ids

    @model_prov_ids.setter
    def model_prov_ids(self, model_prov_ids):
        """Sets the model_prov_ids of this ContextElement.

        Identifiers of NWDAFs that provide ML models used by the NF service consumer.  # noqa: E501

        :param model_prov_ids: The model_prov_ids of this ContextElement.
        :type model_prov_ids: List[str]
        """
        if model_prov_ids is not None and len(model_prov_ids) < 1:
            raise ValueError("Invalid value for `model_prov_ids`, number of items must be greater than or equal to `1`")  # noqa: E501
