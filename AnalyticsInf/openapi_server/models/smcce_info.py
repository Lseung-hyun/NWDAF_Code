...
class SmcceInfo(Model):
    ...
    def __init__(self, dnn=None, snssai=None, smcce_ue_list=None):  # noqa: E501
        ...
        :type smcce_ue_list: List[SmcceUeList]
        """
        self.openapi_types = {
            'dnn': str,
            'snssai': Snssai,
            'smcce_ue_list': List[SmcceUeList]
        }
    ...
    def smcce_ue_list(self, smcce_ue_list):
        ...
        :type smcce_ue_list: List[SmcceUeList]
        """
        if smcce_ue_list is not None and len(smcce_ue_list) < 1:
            raise ValueError("Invalid value for `smcce_ue_list`, number of items must be greater than or equal to `1`")  # noqa: E501
