...
class EventReportingRequirement(Model):
    ...
    def __init__(self, accuracy=None, start_ts=None, end_ts=None, offset_period=None, samp_ratio=None, max_object_nbr=None, max_supi_nbr=None, time_ana_needed=None, ana_meta=None, ana_meta_ind=None):  # noqa: E501
