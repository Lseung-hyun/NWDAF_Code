...
class NfLoadLevelInformation(Model):
    ...
    def __init__(self, nf_type=None, nf_instance_id=None, nf_set_id=None, nf_status=None, nf_cpu_usage=None, nf_memory_usage=None, nf_storage_usage=None, nf_load_level_average=None, nf_load_levelpeak=None, snssai=None, confidence=None):  # noqa: E501
