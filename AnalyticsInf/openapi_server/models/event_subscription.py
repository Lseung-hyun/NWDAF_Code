...
class EventSubscription(Model):
    ...
    def __init__(self, any_slice=None, app_ids=None, dnns=None, dnais=None, event=None, extra_report_req=None, load_level_threshold=None, notification_method=None, matching_dir=None, nf_load_lvl_thds=None, nf_instance_ids=None, nf_set_ids=None, nf_types=None, network_area=None, max_top_app_ul_nbr=None, max_top_app_dl_nbr=None, nsi_id_infos=None, nsi_level_thrds=None, qos_requ=None, qos_flow_ret_thds=None, ran_ue_throu_thds=None, repetition_period=None, snssaia=None, tgt_ue=None, cong_thresholds=None, nw_perf_requs=None, bw_requs=None, excep_requs=None, expt_ana_type=None, expt_ue_behav=None, rat_types=None, frequency=None, list_of_ana_subsets=None):  # noqa: E501
        ...
        :param rat_types: The rat_types of this EventSubscription.  # noqa: E501
        :type rat_types: List[RatType]
        :param frequency: The frequency of this EventSubscription.  # noqa: E501
    ...
    @property
    def rat_types(self):
        """Gets the rat_types of this EventSubscription.


        :return: The rat_types of this EventSubscription.
        :rtype: List[RatType]
        """
    ...
    def rat_types(self, rat_types):
        """Sets the rat_types of this EventSubscription.


        :param rat_types: The rat_types of this EventSubscription.
        :type rat_types: List[RatType]
        """
    ...
    @property
    def frequency(self):
        """Gets the frequency of this EventSubscription.


        :return: The frequency of this EventSubscription.
        :rtype: List[int]
        """
    ...
    def frequency(self, frequency):
        """Sets the frequency of this EventSubscription.


        :param frequency: The frequency of this EventSubscription.
        :type frequency: List[int]
        """
        if frequency is not None and len(frequency) < 1:
            raise ValueError("Invalid value for `frequency`, number of items must be greater than or equal to `1`")  # noqa: E501
