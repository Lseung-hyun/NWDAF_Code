...
class NetworkAreaInfo(Model):
    ...
    def __init__(self, ecgis=None, ncgis=None, g_ran_node_ids=None, tais=None):  # noqa: E501
        """NetworkAreaInfo - a model defined in OpenAPI

        :param ecgis: The ecgis of this NetworkAreaInfo.  # noqa: E501
        :type ecgis: List[Ecgi]
        :param ncgis: The ncgis of this NetworkAreaInfo.  # noqa: E501
        :type ncgis: List[Ncgi]
        :param g_ran_node_ids: The g_ran_node_ids of this NetworkAreaInfo.  # noqa: E501
        :type g_ran_node_ids: List[GlobalRanNodeId]
        :param tais: The tais of this NetworkAreaInfo.  # noqa: E501
        :type tais: List[Tai]
        """
        self.openapi_types = {
            'ecgis': List[Ecgi],
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'NetworkAreaInfo':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The NetworkAreaInfo of this NetworkAreaInfo.  # noqa: E501
    ...
    @property
    def ecgis(self):
        """Gets the ecgis of this NetworkAreaInfo.

        Contains a list of E-UTRA cell identities.  # noqa: E501

        :return: The ecgis of this NetworkAreaInfo.
        :rtype: List[Ecgi]
        """
        return self._ecgis
    ...
    def ecgis(self, ecgis):
        """Sets the ecgis of this NetworkAreaInfo.

        Contains a list of E-UTRA cell identities.  # noqa: E501

        :param ecgis: The ecgis of this NetworkAreaInfo.
        :type ecgis: List[Ecgi]
        """
    ...
    @property
    def ncgis(self):
        """Gets the ncgis of this NetworkAreaInfo.

        Contains a list of NR cell identities.  # noqa: E501

        :return: The ncgis of this NetworkAreaInfo.
        :rtype: List[Ncgi]
        """
        return self._ncgis
    ...
    def ncgis(self, ncgis):
        """Sets the ncgis of this NetworkAreaInfo.

        Contains a list of NR cell identities.  # noqa: E501

        :param ncgis: The ncgis of this NetworkAreaInfo.
        :type ncgis: List[Ncgi]
        """
    ...
    def g_ran_node_ids(self):
        """Gets the g_ran_node_ids of this NetworkAreaInfo.

        Contains a list of NG RAN nodes.  # noqa: E501

        :return: The g_ran_node_ids of this NetworkAreaInfo.
    ...
    def g_ran_node_ids(self, g_ran_node_ids):
        """Sets the g_ran_node_ids of this NetworkAreaInfo.

        Contains a list of NG RAN nodes.  # noqa: E501

        :param g_ran_node_ids: The g_ran_node_ids of this NetworkAreaInfo.
        :type g_ran_node_ids: List[GlobalRanNodeId]
        """
    ...
    @property
    def tais(self):
        """Gets the tais of this NetworkAreaInfo.

        Contains a list of tracking area identities.  # noqa: E501

        :return: The tais of this NetworkAreaInfo.
        :rtype: List[Tai]
        """
        return self._tais
    ...
    @tais.setter
    def tais(self, tais):
        """Sets the tais of this NetworkAreaInfo.

        Contains a list of tracking area identities.  # noqa: E501

        :param tais: The tais of this NetworkAreaInfo.
        :type tais: List[Tai]
        """
